...
def focal_loss(yTrue, yPred):
    ...
    cross_entropy = -yTrue*K.log(yPred)
    # Calculate weight that consists of  modulating factor and weighting factor
    weight = alpha * yTrue * K.pow((1-yPred), gamma)
...
#loss="categorical_crossentropy",#
    if optimizer_name is not None:
        model.compile(loss=lambda yTrue, yPred: focal_loss(yTrue, yPred),
