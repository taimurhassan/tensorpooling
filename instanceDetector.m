...
for i=1:nfile
    ...
    g1 = imfill(bwareaopen(imbinarize(rgb2gray(gun1m),0.1),threshold),'holes');
    g2 = imfill(bwareaopen(imbinarize(rgb2gray(gun2m),0.1),threshold),'holes');
    g3 = imfill(bwareaopen(imbinarize(rgb2gray(gun3m),0.1),threshold),'holes');
    g4 = imfill(bwareaopen(imbinarize(rgb2gray(gun4m),0.1),threshold),'holes');
    g5 = imfill(bwareaopen(imbinarize(rgb2gray(gun5m),0.1),threshold),'holes');
    g6 = imfill(bwareaopen(imbinarize(rgb2gray(gun6m),0.1),threshold),'holes');
    k1 = imfill(bwareaopen(imbinarize(rgb2gray(knife1m),0.1),2*threshold),'holes');

    %     k1 = bwmorph(bwmorph(bwmorph(bwmorph(bwmorph(bwmorph(bwmorph(bwmorph ...
%     (bwmorph(bwmorph(bwmorph(bwmorph(k1,'thicken'),'thicken'),'dilate'),'thicken')...
%     ,'thicken'),'dilate'),'thicken'),'thicken'),'dilate'),'thicken'),'thicken'),'dilate');
    k2 = imfill(bwareaopen(imbinarize(rgb2gray(knife2m),0.1),threshold),'holes');
    k3 = imfill(bwareaopen(imbinarize(rgb2gray(knife3m),0.1),threshold),'holes');
    s1 = imfill(bwareaopen(imbinarize(rgb2gray(knife4m),0.1),threshold),'holes');
    s2 = imfill(bwareaopen(imbinarize(rgb2gray(knife5m),0.1),threshold),'holes');
    r1 = imfill(bwareaopen(imbinarize(rgb2gray(razor1m),0.1),threshold),'holes');
    r2 = imfill(bwareaopen(imbinarize(rgb2gray(razor2m),0.1),threshold),'holes');
    w1 = imfill(bwareaopen(imbinarize(rgb2gray(wrench1m),0.1),threshold),'holes');
    w2 = imfill(bwareaopen(imbinarize(rgb2gray(wrench2m),0.1),threshold),'holes');
    sc1 = imfill(bwareaopen(imbinarize(rgb2gray(scissor1m),0.1),threshold),'holes');
    p1 = imfill(bwareaopen(imbinarize(rgb2gray(plier1m),0.1),threshold),'holes');
    p2 = imfill(bwareaopen(imbinarize(rgb2gray(plier2m),0.1),threshold),'holes');
    st1 = imfill(bwareaopen(imbinarize(rgb2gray(knife61m),0.1),threshold),'holes');
    scr1 = imfill(bwareaopen(imbinarize(rgb2gray(scissor21m),0.1),threshold),'holes');
    po1 = imfill(bwareaopen(imbinarize(rgb2gray(others1m),0.1),threshold),'holes');
    h1 = imfill(bwareaopen(imbinarize(rgb2gray(hammer1m),0.1),threshold),'holes');
    a1 = imfill(bwareaopen(imbinarize(rgb2gray(wrench31m),0.1),threshold),'holes');
    
    rMax = 1000;
    gun1m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(gun1m),0.1),threshold),'canny'),'skel'),rMax);
    gun2m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(gun2m),0.1),threshold),'canny'),'skel'),rMax);
    gun3m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(gun3m),0.1),threshold),'canny'),'skel'),rMax);
    gun4m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(gun4m),0.1),threshold),'canny'),'skel'),rMax);
    gun5m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(gun5m),0.1),threshold),'canny'),'skel'),rMax);
    gun6m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(gun6m),0.1),threshold),'canny'),'skel'),rMax);
    knife1m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(knife1m),0.1),threshold),'canny'),'skel'),rMax);
    knife2m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(knife2m),0.1),threshold),'canny'),'skel'),rMax);
    knife3m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(knife3m),0.1),threshold),'canny'),'skel'),rMax);
    knife4m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(knife4m),0.1),threshold),'canny'),'skel'),rMax);
    knife5m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(knife5m),0.1),threshold),'canny'),'skel'),rMax);
    razor1m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(razor1m),0.1),threshold),'canny'),'skel'),rMax);
    razor2m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(razor2m),0.1),threshold),'canny'),'skel'),rMax);
    wrench1m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(wrench1m),0.1),threshold),'canny'),'skel'),rMax);
    wrench2m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(wrench2m),0.1),threshold),'canny'),'skel'),rMax);
    scissor1m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(scissor1m),0.1),threshold),'canny'),'skel'),rMax);
    plier1m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(plier1m),0.1),threshold),'canny'),'skel'),rMax);
    plier2m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(plier2m),0.1),threshold),'canny'),'skel'),rMax);
    knife61m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(knife61m),0.1),threshold),'canny'),'skel'),rMax);
	scissor21m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(scissor21m),0.1),threshold),'canny'),'skel'),rMax);
    others1m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(others1m),0.1),threshold),'canny'),'skel'),rMax);
    hammer1m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(hammer1m),0.1),threshold),'canny'),'skel'),rMax);
    wrench31m = connectContours(bwmorph(edge(bwareaopen(imbinarize(rgb2gray(wrench31m),0.1),threshold),'canny'),'skel'),rMax);
